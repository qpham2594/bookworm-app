...
export default async function Header() {
    ...
    return (
        <header className="bg-lightpurple py-6 flex flex-row items-center justify-center pr-6">
                    ...
                    <nav aria-label="Global" className="hidden md:flex">
                        {session ? (
                            ...
                            <div className="flex items-center gap-4">
                                <a className="rounded-md px-5 py-2.5 text-sm font-medium text-white bg-amber-900 hover:bg-purple-800 hover:shadow-md" href="/signin">Login</a>
                                <a className="rounded-md text-white px-5 py-2.5 text-sm font-medium bg-amber-900 hover:bg-purple-800 hover:shadow-md" href="/register">Register</a>
                            </div>
                        )}
                    </nav>
                </div>
            ...
            {/* Display mobile nav items */}
            <div className="block md:hidden">
                <nav aria-label="Mobile">
                    {session ? (
                        <ul className="flex flex-row items-center justify-center gap-4 text-sm text-amber-900 font-semibold">
                            <Link href="/dashboard" className="hover:text-purple-800 hover:shadow-md">Dashboard</Link>
                            <Link href="/wishlist" className="hover:text-purple-800 hover:shadow-md">Wishlist</Link>
                            <Link href="/favorites" className="hover:text-purple-800 hover:shadow-md">Favorites</Link>
                            <Link href="/signout" className="hover:text-purple-800 hover:shadow-md">Signout</Link>
